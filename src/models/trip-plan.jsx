...
const pickRouteTypes = (trip) => {
  ...
  if (trip.hasMode('transit')) {
    ...
    if (trip.hasMode('bike')) { modeSets.push('bikeToTransit'); }
    ...
    if (trip.hasMode('bike')) { modeSets.push('bike'); }
 ...
 * @returns
 */
const filterPlan = (plan, preferences) => {
