...
const Help = () => {
  return (
    <Flex direction="column" paddingX={20} paddingY={10}>
      ...
      <Divider marginY={10} />
      <Flex direction="column" align="center" justify="center">
        <Heading as="h4" size="md" aria-label="">
          Call Center
        </Heading>
        <p aria-label="Call Center Phone">
          Phone:{" "}
          <a
            href="tel:+17168884600"
            style={{ color: "dodgerblue" }}
            aria-label="716-888-4600"
          >
            716-888-4600
          </a>
        </p>
        <br />
        <p aria-label="Hours of Operation">Hours of Operation</p>
        <p aria-label="Monday - Friday, 6:00 AM to 7:00 PM EST">
          Monday - Friday, 6:00 AM to 7:00 PM EST
        </p>
      </Flex>
      ...
      <Flex direction="column">
        <Link href="#location" color="dodgerblue" role="link">
          Location
        </Link>
        <Link href="#sign-up" color="dodgerblue" role="link">
          Sign Up
        </Link>
        <Link href="#login" color="dodgerblue" role="link">
          Login
        </Link>
        <Link href="#forgot-password" color="dodgerblue" role="link">
          Forgot Password
        </Link>
        <Link href="#continue-as-guest" color="dodgerblue" role="link">
          Continue as Guest
        </Link>
        <Link href="#find-nearby-routes" color="dodgerblue" role="link">
          Find Nearby Routes
        </Link>
        <Link href="#schedule-a-trip" color="dodgerblue" role="link">
          Schedule a Trip
        </Link>
        <Link href="#home" color="dodgerblue" role="link">
          Home
        </Link>
        <Link href="#trip-activity" color="dodgerblue" role="link">
          Trip Activity
        </Link>
        <Link href="#profile-and-settings" color="dodgerblue" role="link">
          Profile and Settings
        </Link>
        <Link href="#feedback" color="dodgerblue" role="link">
          Feedback
        </Link>
      ...
      <Flex id="location" direction="column" aria-label="Location">
        ...
        <UnorderedList styleType="none" spacing={3}>
          <ListItem>
            <Text>
              Visit{" "}
              <Link
                href="https://completetrip.etch.app"
                color="red"
                fontWeight="bold"
                role="link"
              >
                https://completetrip.etch.app
              </Link>{" "}
          ...
          <ListItem>
            <Text>
              Once on the website, allow location services by clicking{" "}
        ...
        <UnorderedList styleType="none" spacing={3}>
          ...
          <ListItem>
            ...
            <UnorderedList styleType="none" spacing={3}>
              <ListItem>
                <Text>
                  Your password must meet certain requirements to move forward.
                  As shown below, the unmet requirements will begin as red and
                  will turn green as they are met, indicating success.
                </Text>
              </ListItem>
              <ListItem>
                <Text display="flex" alignItems="center">
                  Toggling the{" "}
                  <img src="./help_images/eye.png" alt="eye" class="trash" />{" "}
                  button will either show or hide your password.
                </Text>
              </ListItem>
            </UnorderedList>
          </ListItem>
          <ListItem>
            <Text>
              ...
              , the box will automatically check.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
          ...
          <ListItem>
            <Text>
              If you remember that you had previously created an account, you
              can click{" "}
              <Text as="span" color="red" fontWeight="bold">
                Login
              </Text>{" "}
          ...
          <ListItem>
            <Text>
              Enter the 6-digit code that was sent to your email account.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
              You will be prompted to login once your account has been created.
          ...
          <ListItem>
            <Text>
              Add contact information for two-step verification purposes. Your
              email address will pre-populate and you will just need to enter
          ...
          <ListItem>
            <Text>
              The next screen will prompt you to add your home address and click{" "}
              <Text as="span" color="red" fontWeight="bold">
                Next
              </Text>
              .
          ...
          <ListItem>
            <Box>
              <img
                src="./help_images/Picture4.png"
                alt="Address and Coordinator"
              />
            </Box>
          </ListItem>
          <ListItem>
            <Text>
              The next screen will confirm your information and that of your
              primary coordinator.{" "}
              <Text as="span" color="red" fontWeight="bold">
                Click Verify your phone number to continue
              </Text>
              .
            </Text>
          </ListItem>
          <ListItem>
            <Text>
              Once that is verified, a 6-digit code will be sent to your email.
              Enter the code.
            </Text>
          </ListItem>
          <ListItem>
      ...
      <Flex id="login" direction="column" aria-label="Login">
        <Heading as="h4" size="md">
          Login
        </Heading>
        <UnorderedList styleType="none" spacing={3}>
          <ListItem>
            <Text>
              If you have already created an account, click{" "}
              <Text as="span" color="red" fontWeight="bold">
                Login/Sign Up
              </Text>
              .
          ...
          <ListItem>
            <Text>
              Toggling the{" "}
              <img src="./help_images/eye.png" alt="eye" class="trash" /> button
              will either show or hide your password.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
              If you remember that you haven’t previously created an account,
              you can click{" "}
              <Text as="span" color="red" fontWeight="bold">
                Create Account
              </Text>{" "}
        ...
        <UnorderedList styleType="none" spacing={3}>
          <ListItem>
            <Text>
              ...
              allows a user to preview routes, but they will be unable to
              schedule a trip.
            </Text>
          </ListItem>
          <ListItem>
      ...
      >
        ...
        <UnorderedList styleType="none" spacing={3}>
          ...
          <ListItem>
            <Text>
              Start by panning to a location on the map or by entering it in the
              search box.
            </Text>
          </ListItem>
          <ListItem>
          ...
          <ListItem>
            <Text>
              If you click a route, all the stops will show on the map and
              listed on the left side with details.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
        ...
        <UnorderedList styleType="none" spacing={3}>
          <ListItem>
            <Text>
              ...
              button to book transportation.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
              Enter the locations, date, and time and click{" "}
              <Text as="span" color="red" fontWeight="bold">
                Next
              </Text>
              .
          ...
          <ListItem>
            <Text>
              ...
              if you’d like to review other options.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
              A notification will show that the trip was successfully scheduled.
            </Text>
          </ListItem>
          <ListItem>
            <Box>
      ...
      <Flex id="home" direction="column" aria-label="Home">
        <Heading as="h4" size="md">
          Home
        </Heading>
        <UnorderedList styleType="none" spacing={3}>
          <ListItem>
            <Text>
              On the home page, any scheduled trips will be displayed.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
              Trips can be favorited by clicking the star next to the trip.
            </Text>
            <UnorderedList styleType="none" spacing={3}>
              <ListItem>
                <Text>
                  Give the trip a name and click{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Save as Favorite
                  </Text>
                  .
          ...
          <ListItem>
            <Text>
              You can click on the trip to preview the details or cancel it.
            </Text>
          </ListItem>
          <ListItem display="flex" alignItems="center">
            <Box>
      ...
      <Flex id="trip-activity" direction="column" aria-label="Trip Activity">
        <Heading as="h4" size="md">
          Trip Activity
        </Heading>
        <UnorderedList styleType="none" spacing={3}>
          <ListItem>
            <Text>
              On this screen, you’ll be able to view past and upcoming trips.
            </Text>
          </ListItem>
        </UnorderedList>
      </Flex>
        ...
        <UnorderedList styleType="none" spacing={3}>
            ...
            <UnorderedList styleType="none" spacing={3}>
              ...
              <ListItem>
                <Text>
                  ...
                  for changes to your personal information.
                </Text>
              </ListItem>
              <ListItem>
                <Text>
                  Your account can be deleted by clicking{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Delete Account
                  </Text>
                  , typing the prompt, and clicking{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Delete Account
                  </Text>{" "}
                  once more.
          ...
          <ListItem>
            ...
            <UnorderedList styleType="none" spacing={3}>
              ...
              <ListItem>
                <Text>
                  To remove a coordinator, click{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Remove this Coordinator
                  </Text>{" "}
                  and confirm your request by selecting{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Remove
                  </Text>
                  .
              ...
              <ListItem>
                <Text>
                  Additional coordinators can be invited by clicking{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Invite a Coordinator
                  </Text>
                  , entering the necessary information, and selecting{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Invite a Coordinator
                  </Text>{" "}
                  once more.
          ...
          <ListItem>
            ...
            <UnorderedList styleType="none" spacing={3}>
              ...
              <ListItem>
                <Text>
                  Clicking the <img src="./help_images/trash.png" alt="trash" />{" "}
          ...
          <ListItem>
            <Box>
              <img
                src="./help_images/Picture18.png"
                alt="NFTA PAL Direct Users"
              />
            </Box>
          </ListItem>
          <ListItem>
            ...
            <UnorderedList styleType="none" spacing={3}>
              <ListItem>
                <Text>
                  The terms and conditions will be listed on this page.
                </Text>
              </ListItem>
            </UnorderedList>
          </ListItem>
            ...
            <UnorderedList styleType="none" spacing={3}>
              ...
              <ListItem>
                <Text>
                  ...
                  the preferred mode(s) of transportation.
                </Text>
              </ListItem>
            </UnorderedList>
          </ListItem>
          ...
          <ListItem>
            ...
            <UnorderedList styleType="none" spacing={3}>
              <ListItem>
                <Text>
                  Your password may be changed to something new on this page by
                  entering the prompted information and clicking{" "}
                  <Text as="span" color="red" fontWeight="bold">
                    Change Password
                  </Text>
                  .
      ...
      <Flex id="feedback" direction="column" aria-label="Feedback">
        <Heading as="h4" size="md">
          Feedback
        </Heading>
        <UnorderedList styleType="none" spacing={3}>
          <ListItem>
            <Text>
              If you wish to suggest changes to the website or report any
              issues, you may do so by filling out the feedback tool.
            </Text>
          </ListItem>
          <ListItem>
            <Text>
              Check whether or not you’d like to be contacted if there are any
          ...
          <ListItem>
            <Text>
              Type the necessary information and click{" "}
              <Text as="span" color="red" fontWeight="bold">
                Submit
              </Text>
              .
