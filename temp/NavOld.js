...
export default function Navbar({ isOpen, onToggle, action1, action2 }) {
  ...
  return (
    ...
    >
      ...
      <Box
        as="span"
        bg={useColorModeValue('brand', 'gray.800')}
        p={1}
        borderRadius={'sm'}
      >
        <Image src={'./assets/images/logo.png'} h={8} />
      </Box>
...
//   return (
//     <Stack direction={'row'} spacing={4} id="desktop-nav">
